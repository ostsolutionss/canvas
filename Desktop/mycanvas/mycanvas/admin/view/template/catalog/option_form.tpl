...
<div id="content">
          ...
          <table id="option-value" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr id="option-value-row<?php echo $option_value_row; ?>">
                   <?php $opt_id =$option_value['option_value_id']; ?>
                ...
                <td class="text-right"><input type="text" name="option_value[<?php echo $option_value_row; ?>][price]" value="<?php echo $option_value['price']; ?>" class="form-control" /></td>
                ...
                <td>
                    <?php
                    $option_status = $option_value['option_value_description'][1]['status'];
                     ?>
                    <a href="javascript:void(0);" id='disable_row<?php echo $option_value_row; ?>' onclick='disable("<?php echo $opt_id ; ?>","<?php echo $option_status;?>");'> 
                      <?php
                        if($option_status == 0)
                        {
                            echo "Enable";
  ...
  {
      var abc = "<?php echo $_GET['option_id']; ?>";
  
   url = 'index.php?route=catalog/option/edit&token=<?php echo $token; ?>&option_id='+abc;
     url += '&option_value_row=' + id + '&status='+status;
    location = url;
...
var curr_status = "$option_value['option_value_description'][1]['status']";
var opt_id = "$option_value['option_value_id']";
...
function addOptionValue() {
	...
	html += '  </td>';
        ...
        html += '  <td class="text-right"><input type="text" name="option_value[' + option_value_row + '][price]" value="" placeholder="<?php echo $entry_price; ?>" class="form-control" /></td>';
	html += '  <td class="text-right"><input type="text" name="option_value[' + option_value_row + '][sort_order]" value="" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>';
        html += '<td><a href="javascript:void(0);" id="disable_row' + option_value_row + '" onclick="('+opt_id +'"1);"> Enable</a></td>';
