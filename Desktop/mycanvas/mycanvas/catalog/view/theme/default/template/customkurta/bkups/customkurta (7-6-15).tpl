                        ...
                        <div class="item active">
                            <div class="slider8">
                                ...
                                <div class="slide">
                                    ...
                                    <font class="fabprice"><?php echo $option_valuess['name']; ?>,$<b id="fabprice<?php echo $option_valuess['option_value_id']; ?>"><?php echo $option_valuess['price']; ?> </b> </font>
                                </div>
                                <?php
                                } ?>
                            </div>
                                 ...
                                 <div class="slider8">
                                        ...
                                        if($femb != '')
                                        {
                                            ...
                                            <div class="slide">
                                                ...
                                                <font class="embprice">$<b id="fabembprice<?php echo $fembrodry['id']; ?>"><?php echo $fembrodry['price'];?> </b> </font>
                                            </div>
                                      <?php } ?>
                                            ...
                                            <font class="embprice" style="display:none;">$<b id="fabembpricefab0"><?php echo "0";?> </b>  </font>
                                   <?php } ?>
                                    </div>
                             ...
                             <div class="digitalsection" >
                                 <div class="slider8">
                                        ...
                                        <div class="slide">
                                            ...
                                            <font class="digiprice"> $<b id="fabdigiprice<?php echo $fdigital1['id']; ?>"><?php echo   $fdigital1['price'];?> </b>  </font>
                                        </div>
                                        <?php } ?>
                                            ...
                                            <font class="digiprice" style="display:none;">$<b id="fabdigipricedigi0"><?php echo "0";?> </b> </font>
                                        <?php } ?>
                                 </div>
                             ...
                             <div class="blocksection" style="display:none;">
                                <div class="slider8">
                                        ...
                                        <div class="slide">
                                            ...
                                            $<b id="fabblockprice<?php echo $fblockp['id']; ?>"><?php echo  $fblockp['price'];?> </b>
                                            </font>
                                        </div>
                                        <?php } ?>
                                            ...
                                            <font class="blockprice" style="display:none;"> $<b id="fabblockpriceblock0"><?php echo "0"?> </b> </font>
                                        <?php } ?>
                                </div>
                             ...
                             <div class="screensection" style="display:none;">
                                <div class="slider8">
                                        ...
                                        <div class="slide">
                                            ...
                                            $<b id="fabscreenprice<?php echo $fscreenp['id']; ?>"><?php echo $fscreenp['price'];?> </b>
                                            </font>
                                        </div>
                                        <?php } ?>
                                            ...
                                            <font class="screenprice" style="display:none;"> $<b id="fabscreenpricescreen0"><?php echo "0"?> </b> </font>
                                        <?php } ?>
                                </div>
                              ...
                              <div id="shirtareas" style="display:none;">
                                    <div class="slider8">
                                        ...
                                        ?>
                                        <div class="slide">
                                            <img src="image/<?php echo $frontarea1['image']; ?>" alt="<?php echo $frontarea1['name']; ?>" id="<?php echo $frontarea1['name']; ?>" class="sel-area sel-area1 img-responsive" />
                                            <font>
                                ...
                                <div class="slider8">
                                 <?php
                                        if($neckstyle != '')
                                        {
                                            ...
                                            <div class="slide">
                                                <img src="<?php echo $neckstyle1['design_main_img']; ?>" alt="<?php echo $neckstyle1['design_name']; ?>" id="<?php echo $neckstyle1['design_name']; ?>" class="neck-sec img-responsive" />
                                                <font><?php echo $neckstyle1['design_name']; ?></font>
                                            </div>
                                            <?php } ?>
                                            <img style="border:1px solid #ccc;" src="upload/no-fill/no-fill-patrn.png" alt="no-fill-patrn" id="no-fill" class="neck-sec img-responsive" />
                                            <font>no-fill</font>
                                 <?php  } ?>
                                </div>
                        ...
                        <div class="item active">
                            ...
                            <div id="shirtsstyle" >
                                <div class="slider8">
                                    ...
                                    <div class="slide">
                                        <img src="<?php echo $sleevelength1['attached_image']; ?>" alt="<?php echo $sleevelength1['length']; ?>" id="<?php echo $sleevelength1['length']; ?>" class="sleeves-sec img-responsive"/>
                            ...
                            <div class="slvfabric" style="display:none;">
                                <div class="slider8">
                                    ...
                                    { ?>
                                        <div class="slide">
                                            <img src="image/<?php echo $option_valuess['image']; ?>" class="slevfab img-responsive" />
                                        </div>
                                    <?php
                                    } 
                                    } ?>
                    ...
                    <div class="view_top">
                        <!--<img class="view_image" alt="" src="catalog/view/theme/default/image/images/icon_img34.png"> -->
                              <div class="frontcanvascontainer" id="frontcanvascontainer">
                                <!--  CANVAS   -->
                                <canvas id="canvas" width=190 height=380 style="background:url(catalog/view/theme/default/image/shirt.png); position: absolute; z-index: 9;">
                                </canvas>
                                <canvas id="frontcanvas" width=190 height=380 style="z-index: 99;">
                                </canvas>
                                <!--     CANVAS    -->
                            </div> 
                           <div class="backcanvas" id="backcanvas" style="display:none;">
                                   CANVAS   
                                <canvas id="backside" width=190 height=380 style="background:url(catalog/view/theme/default/image/back/back.png); position: absolute; z-index: 9;">
                                </canvas>
                                <canvas id="backside1" width=190 height=380 style="z-index: 99;">
                                </canvas>
                                <!--     CANVAS  -->
                            </div> 
