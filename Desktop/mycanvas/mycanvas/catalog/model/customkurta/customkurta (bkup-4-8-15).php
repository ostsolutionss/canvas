...
class Modelcustomkurtacustomkurta extends Model {
	...
	public function getOptions() {
        ...
        { 
                $area=$this->db->query("SELECT * FROM " . DB_PREFIX . "products_image where design='Digital' and area = 'Full'");
                return  $area->rows; 
        } 
        ...
        { 
                $area=$this->db->query("SELECT * FROM " . DB_PREFIX . "products_image where design='Embroidery' and area = 'Full'");
                return  $area->rows; 
        } 
        ...
        { 
                $area=$this->db->query("SELECT * FROM " . DB_PREFIX . "products_image where design='Block Print' and area = 'Full'"); 
                return  $area->rows; 
        } 
        ...
        {
             $area=$this->db->query("SELECT * FROM " . DB_PREFIX . "products_image where design='Screen Print' and area = 'Full'"); 
             return  $area->rows; 
        }
