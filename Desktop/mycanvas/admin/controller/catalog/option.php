...
class ControllerCatalogOption extends Controller {
	...
	public function edit() {
		...
		$this->load->model('catalog/option');
                ...
                if(isset($_GET['option_value_row']) && isset($_GET['status']))
                {
                $disoptionid = $_GET['option_value_row'];
                $disoptionparentid = $_GET['option_id'];
                $current_status = $_GET['status'];
                $opt_v_row=$this->model_catalog_option->disableoption($disoptionid,$disoptionparentid,$current_status);
