...
<div id="content">
  <div class="page-header">
    ...
    <?php
        ...
        echo "Bottom Length added successfully";
        }
        if(!empty($_GET['msg']) && $_GET['msg'] == "deletesuccess"){
        
        echo "Bottom Length Deleted successfully";
        }
        ?>
       </div>
  <div class="container-fluid">
      ...
      <div class="panel-body">
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-popular" class="form-horizontal">
                <div class="form-group">
                    <label class="col-sm-2 control-label">Bottom Length</label>
                    <div class="col-sm-10">
                      <input type="text"  name="designname1" value="" placeholder="Bottom Length" id="designname1" class="form-control" />
                    </div>
                 </div>
                <div class="form-group">
          ...
          <div class="listing">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php 
                        foreach($listbtmlngth as $listbotmlength)
                        {
                        $btmlngthid = $listbotmlength['id'];
                    ?>
                    <tr>
                        <td>
                            <?php echo $listbotmlength['bottom_length']; ?>
                        </td>
                        <td><img src="<?php echo $base.$listbotmlength['bottom_length_img']; ?>" class="customimg"/></td>
                        <td style="text-align: center;">
                            <a href="javascript:void(0);" id='removeblngth<?php echo $btmlngthid ; ?>' data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger" onclick='deletelength("<?php echo $btmlngthid ; ?>");'> <i class="fa fa-minus-circle"></i> </a>
                        </td>
                    </tr>
                    <?php } ?>
                </table>
 ...
 function deletelength(id)
  {
     ...
     var url = 'index.php?route=custom/bottom_length/deleteoption&token=<?php echo $token; ?>';
     url += '&length=' + id;
     location = url;
...
$('.form-group .add-box').click(function(){
    ...
    txt = txt + " <label class=\"col-sm-2 control-label\" >Bottom Length</label>";
    txt = txt + " <div class=\"col-sm-10\">";
    txt = txt + " <input type=\"text\"  name=\"designname"+n+"\" value=\"\" placeholder=\"Bottom Length\" id=\"designname"+n+"\" class=\"form-control\" />";
    txt = txt + " </div>";
    txt = txt + " </div>";
    txt = txt + " <div class=\"form-group\">";
