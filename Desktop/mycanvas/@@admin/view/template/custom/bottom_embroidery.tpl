...
<div id="content">
  <div class="page-header">
    ...
    <?php
        ...
        echo "Bottom Embroidery added successfully";
        }
        if(!empty($_GET['msg']) && $_GET['msg'] == "deletesuccess"){
        
        echo "Bottom Embroidery Deleted successfully";
        }
        ?>
       </div>
  <div class="container-fluid">
      ...
      <div class="panel-body">
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-popular" class="form-horizontal">
                <div class="form-group">
                    <label class="col-sm-2 control-label" >Embroidery Name</label>
                    <div class="col-sm-10">
                      <input type="text"  name="designname1" value="" placeholder="Enter Embroidery Design Name" id="designname1" class="form-control" />
                    </div>
                 </div>
                <div class="form-group">
          ...
          <div class="listing">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php 
                        foreach($emblisting as $emblist)
                        {
                            $emblistid = $emblist['id'];
                    ?>
                    <tr>
                        <td>
                            <?php echo $emblist['emb_name']; ?>
                        </td>
                        <td><img src="<?php echo $base.$emblist['emb_main_img']; ?>" class="customimg"/></td>
                        <td style="text-align: center;">
                            <a href="javascript:void(0);" id='removeblngth<?php echo $emblistid ; ?>' data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger" onclick='deleteemb("<?php echo $emblistid ; ?>");'> <i class="fa fa-minus-circle"></i> </a>
                        </td>
                    </tr>
                    <?php } ?>
                </table>
...
<script type="text/javascript">
  function deleteemb(id)
  {
     ...
     var url = 'index.php?route=custom/bottom_embroidery/delete_emb&token=<?php echo $token; ?>';
     url += '&emb=' + id;
     location = url;
...
$('.form-group .add-box').click(function(){
    ...
    txt = txt + " <label class=\"col-sm-2 control-label\" >Embroidery Name</label>";
    txt = txt + " <div class=\"col-sm-10\">";
    txt = txt + " <input type=\"text\"  name=\"designname"+n+"\" value=\"\" placeholder=\"Enter Embroidery Design Name\" id=\"designname"+n+"\" class=\"form-control\" />";
    txt = txt + " </div>";
    txt = txt + " </div>";
    txt = txt + " <div class=\"form-group\">";
