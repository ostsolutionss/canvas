...
<div id="content">
  <div class="page-header">
    ...
    <?php
        ...
        echo "Border Colour added successfully";
        }
        if(!empty($_GET['msg']) && $_GET['msg'] == "deletesuccess"){
        
        echo "Border Colour Deleted successfully";
        }
        ?>
       </div>
  <div class="container-fluid">
            ...
            <div class="listing">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php 
                        ...
                        foreach($bordercolorlist as $bordercolorlisting)
                        {
                            $nbid = $bordercolorlisting['id'];
                    ?>
                    <tr>
                        <td style="height: 68px; text-align: center;">
                            <p>
                                <span style="background-color: <?php echo $bordercolorlisting['neck_border_color']; ?>; padding: 15px 60px 18px 0px; border-radius: 3px; border: 2px solid #dddddd;" ></span>
                            </p>
                        </td>
                        <td style="text-align: center;">
                            <a href="javascript:void(0);" id='removeborder<?php echo $nbid ; ?>' data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger" onclick='deletebcolor("<?php echo $nbid ; ?>");'> <i class="fa fa-minus-circle"></i> </a>
                        </td>
                    </tr>
                    <?php } ?>
                </table>
...
<script>
  function deletebcolor(id)
  {
    
     var url = 'index.php?route=custom/neck_bordercolor/deleteoptions&token=<?php echo $token; ?>';
     url += '&bordercolor=' + id;
     location = url;
