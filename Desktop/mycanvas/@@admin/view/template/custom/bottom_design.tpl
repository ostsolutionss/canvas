  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-popular" data-toggle="tooltip" title="<?php echo $button_save; ?>" id="submit_btn" class="btn btn-primary"><i class="fa fa-save"></i></button>
    ...
    <?php
        ...
        echo "Bottom Design added successfully";
        }
        if(!empty($_GET['msg']) && $_GET['msg'] == "deletesuccess"){
        
        echo "Bottom Design Deleted successfully";
        }
        ?>
       </div>
  <div class="container-fluid">
      ...
      <div class="panel-body">
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-popular" class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text"  name="designname1" value="" placeholder="Title" id="designname1" class="form-control" />
                    </div>
                 </div>
                <div class="form-group">
           ...
           <div class="listing">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php 
                        foreach($listdesign as $listdesigns)
                        {
                            $designid = $listdesigns['id'];
                    ?>
                    <tr>
                        <td>
                            <?php echo $listdesigns['bottom_design_title']; ?>
                        </td>
                        <td><img src="<?php echo $base.$listdesigns['bottom_design_img']; ?>" class="customimg"/></td>
                        <td style="text-align: center;">
                            <a href="javascript:void(0);" id='removeblngth<?php echo $designid ; ?>' data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger" onclick='deletedesign("<?php echo $designid ; ?>");'> <i class="fa fa-minus-circle"></i> </a>
                        </td>
                    </tr>
                    <?php } ?>
                </table>
...
<script type="text/javascript">
   function deletedesign(id)
  {
     ...
     var url = 'index.php?route=custom/bottom_design/deleteoptions&token=<?php echo $token; ?>';
     url += '&design=' + id;
     location = url;
...
$('.form-group .add-box').click(function(){
    ...
    txt = txt + " <label class=\"col-sm-2 control-label\" >Title</label>";
    txt = txt + " <div class=\"col-sm-10\">";
    txt = txt + " <input type=\"text\"  name=\"designname"+n+"\" value=\"\" placeholder=\"Title\" id=\"designname"+n+"\" class=\"form-control\" />";
    txt = txt + " </div>";
    txt = txt + " </div>";
    txt = txt + " <div class=\"form-group\">";
