                                ...
                                <div class="frontdiv">
                                    ...
                                    <span class="digitalsection" style="display:none;">
                                        <?php
                                            ...
                                            {
                                        ?>
                                        <p><img class="digitalimg" id="" alt="<?php echo $fdigital1['design']; ?>" src="<?php echo $fdigital1['attached_image']; ?>" alt="" /></p>
                                        <?php } ?>
                                ...
                                <div class="frontdiv">
                                    ...
                                    <span class="embsection" style="display:none;">
                                        <?php
                                            ...
                                            {
                                        ?>
                                        <p><img class="embimg" alt="<?php echo $fembrodry['design']; ?>" src="<?php echo $fembrodry['attached_image']; ?>" alt="" /></p>
                                        <?php } ?>
                                    </span>
                                </div>
                                <div class="frontdiv">
                                    ...
                                    <span class="blocksection" style="display:none;">
                                        <?php
                                            ...
                                            {
                                        ?>
                                        <p><img class="embimg" alt="<?php echo $fblockp['design']; ?>" src="<?php echo $fblockp['attached_image']; ?>" alt="" /></p>
                                        <?php } ?>
                                    </span>
                                </div>
                    </div>
