...
$(function(){
   ...
   $(".neck-sec").click(function(){
    ...
    $(".sleeves-sec").click(function(){
        ...
        var area = $("#sarea").val();
        var csimg;
        var currnt_simg =$("#sleevelnth").val();
        if(currnt_simg == '')
            {
                    csimg = "";
            }
    ...
    $(".slevfab").click(function(){
        var sfab = $(this).attr("src");
        slevfab.src = sfab;
        newsleve();
    });
    
    $(".slevemb").click(function(){
        ...
        /*   DRAW SLEEVE LENGTH IMAGES  */
              ...
              // if(csimg == "ok")
                 //  {
                          ...
                          /*  var image = ctx2.getImageData(50, 12, 320, 400);
                            ...
                            var abc = ctx2.putImageData(image, 50, 12); */
                            //   if(abc) {
