            ...
            <input type="hidden" name="addcounter" id="addcounter" value="2" style="float:right;"/>
              ...
              <div class="listing">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php 
                        foreach($backlist as $backlisting)
                        {
                            $backid = $backlisting['id'];
                    ?>
                    <tr>
                         <td style="text-align: center;"><?php echo $backlisting['back_type']; ?></td>
                         <td style="text-align: center;"><?php echo $backlisting['back_area']; ?></td>
                         <td style="text-align: center;"><?php echo $backlisting['back_design']; ?></td>
                         <td style="text-align: center;">
                            <img src="<?php echo $base.$backlisting['back_img']; ?>" class="customimg" style="width:80px; height:80px;" />
                        </td>
                        <td style="text-align: center;">
                            <a href="javascript:void(0);" id='removeborder<?php echo $backid ; ?>' data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger" onclick='deleteback("<?php echo $backid ; ?>");'> <i class="fa fa-minus-circle"></i> </a>
                        </td>
                    </tr>
                    <?php } ?>
                </table>
...
{
     var url = 'index.php?route=custom/back/deleteoptions&token=<?php echo $token; ?>';
     url += '&back=' + id;
     location = url;
}
