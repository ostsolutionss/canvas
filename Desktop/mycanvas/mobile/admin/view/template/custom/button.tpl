      ...
      <div class="panel-body">
           ...
           <div class="listing">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php 
                        foreach($buttonlist as $buttonlisting)
                        {
                            $butnid = $buttonlisting['id'];
                    ?>
                    <tr>
                        <td style="text-align: center;">
                            <img src="<?php echo $base.$buttonlisting['attached_image']; ?>" class="customimg" />
                        </td>
                        <td style="text-align: center;">
                            <a href="javascript:void(0);" id='removeborder<?php echo $butnid ; ?>' data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger" onclick='deletebutn("<?php echo $butnid ; ?>");'> <i class="fa fa-minus-circle"></i> </a>
                        </td>
                    </tr>
                    <?php } ?>
                </table>
...
function deletebutn(id)
{
    
     var url = 'index.php?route=custom/button/deleteoptions&token=<?php echo $token; ?>';
     url += '&button=' + id;
     location = url;
