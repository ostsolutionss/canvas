<?php
class ControllerCustomButton extends Controller 
{

	public function index() 
        {
		$this->language->load('front/button');
                $this->load->model('custom/button');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) 
                {
                      ...
                      $data['result']=$this->model_custom_button->addbutton($data);
                      $this->response->redirect($this->url->link('custom/button', 'msg=success&token=' . $this->session->data['token'], 'SSL'));
                }
                
                $data['buttonlist']  = $this->model_custom_button->buttonlist();
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('custom/button', 'token=' . $this->session->data['token'], 'SSL')
		);

		$data['action'] = $this->url->link('custom/button', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->get['page'])) {
			...
			'limit'           => $this->config->get('config_limit_admin')
                ...
                $product_total = $this->model_custom_button->getTotalProducts($filter_data);
                
                $pagination = new Pagination();
		$pagination->total = $product_total;
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('custom/button', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('custom/button.tpl', $data));
	}
	...
	protected function validate() 
        ...
        public function deleteoptions()
        {
            ...
            {   
                ...
                $this->model_custom_button->deleteoption($data);
                $this->response->redirect($this->url->link('custom/button', 'msg=deletesuccess&token=' . $this->session->data['token'], 'SSL'));
            }
       }
