<?php //echo $header; ?>
        ...
        <!-- __________________________   SCRIPT TO SUPPORT HTML5 IN IE OLDER VERSIONS     _______________________________ -->

        <!--[if IE]><script type="text/javascript" src="catalog/view/theme/default/js/ielib/excanvas.js"></script><![endif]-->

        <!-- __________________________   SCRIPT TO SUPPORT HTML5 IN IE OLDER VERSIONS    ________________________________ -->
    
        <!--  ____________________________              STYLE FILES             ______________________________________     -->
        
        <link href="catalog/view/theme/default/stylesheet/customkurtacss/newstyle.css" rel="stylesheet" type="text/css" media="all">
        
        <!--    _________________________________  HTML5CANVAS SCRIPT & STYLE    ________________________________________  -->
...
$(function(){
   ...
   /*  -----------------    NECK  -------------------     */
    ...
    /* ------ SLEEVES ----------- */
      ...
      $(".sbtns").click(function(){                     // For Sleeves Buttons
        slevearea= $("#scolorarea").val();
        sbcolor= $("#sbcolour").val();
        spcolor = $("#slepipecolor").val();
...
<body class="emerald page-emerald leftmenu" data-twttr-rendered="true">
     ...
     <div class="proprice">      
                <span>
                    ...
                    {
                    ?>
                        <input type="text" name="totalprice" id="totalprice" value="<?php echo $proinformation['original_price']; ?>" style="border: medium none; background: none repeat scroll 0% 0% transparent; box-shadow: none; width: 155px;" />
               ...
               <br />
                    ...
                    <br />
                    <button id="button-cart" class="btnstyle addcart btn btn-primary btn-lg btn-block" data-loading-text="Loading..." type="button">
                        Add to Cart
                    </button>
                    <!--<button type="button" id="button-cart" data-loading-text="Loading..."  class="btnstyle addcart">Add to cart</button> -->
                    <!-- <a href="javascript:void(0)" class="btnstyle addcart ">Add to cart</a> -->
     ...
     <div id="viewport" class="viewport-fluid landscape extreme">
                ...
                <div class="backcanvas" id="backcanvas" style="display:none;">
                    <!--     CANVAS   -->
                    <canvas id="backside" width=436 height=567 style="background:url(catalog/view/theme/default/image/back/back.png); position: absolute; z-index: 9;">
                    </canvas>
                            ...
                            <input type="hidden" name="designsections" value="" id="designsections" />
                               <div class="frontdiv">
                                    ...
                                    <span class="embsection" style="display:none;">
                                        ...
                                        if($femb != '')
                                        {
                                            ...
                                            {
                                                                                    ?>
                                        <p><img class="embimg" alt="<?php echo $fembrodry['design']; ?>" src="<?php echo $fembrodry['attached_image']; ?>"  id="<?php echo $fembrodry['id']; ?>"/><br/>
                                            <font class="embprice"><b id="fabembprice<?php echo $fembrodry['id']; ?>"><?php echo $fembrodry['price'];?> </b>Rs/- </font>
                                            </p>
                                        <?php } ?>
                                        <p><img class="embimg" style="border:1px soild #ccc;" alt="no-fill-patrn" src="upload/no-fill/no-fill-patrn.png" id="" />
                                         <font class="embprice" style="display:none;"><b id="fabembprice"><?php echo "0";?> </b> Rs/- </font>
                                        </p>
                                        <?php } ?>
                                    </span>
                                </div>
                             <div class="frontdiv">
                                    ...
                                    <span class="digitalsection" style="display:none;">
                                        ...
                                        ?>
                                        <p><img class="digitalimg" id="<?php echo $fdigital1['id']; ?>" alt="<?php echo $fdigital1['design']; ?>" src="<?php echo $fdigital1['attached_image']; ?>"  /><br/> 
                                            <font class="digiprice"><b id="fabdigiprice<?php echo $fdigital1['id']; ?>"><?php echo   $fdigital1['price'];?> </b> Rs/- </font>
                                            </p>
                                        <?php } ?>
                                        <p><img class="digitalimg" style="border:1px soild #ccc;" alt="no-fill-patrn" src="upload/no-fill/no-fill-patrn.png" id="" />
                                        <font class="digiprice" style="display:none;"><b id="fabdigiprice"><?php echo "0";?> </b> Rs/- </font>
                                        </p>
                                        <?php } ?>
                                    </span>
                                </div>
                                <div class="frontdiv">
                                    ...
                                    <span class="blocksection" style="display:none;">
                                        ...
                                        if($fblock != '')
                                        {
                                            ...
                                            {
                                        ?>
                                        <p><img class="block" alt="<?php echo $fblockp['design']; ?>" id="<?php echo $fblockp['id']; ?>" src="<?php echo $fblockp['attached_image']; ?>" />
                                            <br/>
                                            <font class="blockprice"><b id="fabblockprice<?php echo $fblockp['id']; ?>"><?php echo  $fblockp['price'];?> </b> Rs/- </font>
                                        </p>
                                        <?php } ?>
                                        <p><img class="block" style="border:1px soild #ccc;" id="" alt="no-fill-patrn" src="upload/no-fill/no-fill-patrn.png"  />
                                        <font class="blockprice" style="display:none;"><b id="fabblockprice"><?php echo "0"?> </b> Rs/- </font>
                                        </p>
                                        <?php } ?>
                                    </span>
                                </div>
