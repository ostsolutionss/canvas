...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		$data['new_customer_account_text'] = $this->language->get('new_customer_account_text');
		$data['account_detail_heading'] = $this->language->get('account_detail_heading');
		$data['text_register1'] = $this->language->get('text_register1');
		$data['text_register2'] = $this->language->get('text_register2');
		...
		if (isset($this->request->post['agree'])) {
			...
			$data['agree'] = false;
                ...
                $data['regis_txt'] = $this->model_catalog_information->getreginfo();
		...
		$data['header'] = $this->load->controller('common/loginheader');
