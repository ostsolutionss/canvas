...
<script src="catalog/view/theme/default/js/modernizr.custom.17475.js"></script>

<?php foreach ($styles as $style) { ?>
<link href="<?php echo $style['href']; ?>" type="text/css" rel="<?php echo $style['rel']; ?>" media="<?php echo $style['media']; ?>" />
<?php } ?>
<link href="catalog/view/theme/default/stylesheet/custompage.css" rel="stylesheet">
...
<!--    _________________________________  HTML5CANVAS SCRIPT & STYLE    ________________________________________  -->
 ...
 <script type="text/javascript" src="catalog/view/theme/default/js/customkurtajs/canvasscript.js"></script>
...
<!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries -->
        ...
        <![endif]-->
</head><body class="<?php echo $class; ?>">
<header>
            <div class="head2">
                <div class="container">
                    <div class="row">
...
<div class="down-icon">
<i class="uk-icon-angle-double-down uk-icon-medium" id="down" ></i>
<i class="uk-icon-angle-double-up uk-icon-medium" id="up"></i>
</div>
