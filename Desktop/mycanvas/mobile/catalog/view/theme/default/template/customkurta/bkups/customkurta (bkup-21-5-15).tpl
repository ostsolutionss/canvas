                                   ...
                                   <div class="backdiv">
                                        ...
                                        <div id="backareas" style="display:none;">
                                            ...
                                            <span class="backareasection">
                                               <img src="image/<?php echo $frontarea1['image']; ?>" alt="<?php echo $frontarea1['name']; ?>" id="<?php echo $frontarea1['name']; ?>" class="backsel-area" /><br /><font><?php echo $frontarea1['name']; ?></font>
                                            </span>
                                            <?php } ?>
