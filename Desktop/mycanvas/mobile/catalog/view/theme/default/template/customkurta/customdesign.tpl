...
<?php             
                ...
                $result = $conn->query($sql);
                 ...
                 $color_result = $conn->query($color);
                  ...
                  $sql1 = "SELECT  category_id FROM ".DB_PREFIX."product_to_category WHERE  product_id=$_GET[pro_id]";
                  $result1 = $conn->query($sql1);
                      while($row1 = $result1->fetch_assoc()) {
                     $cate = $row1['category_id'];
                  }
...
<div class="button"></div>
  <form method="POST" enctype="multipart/form-data" action="" id="myForm">
                ...
                <input type="hidden" name="product_price" id="proprice" value="<?php echo $product_info1['price']; ?>" />
        </form>
<div class="middle">
  <div class="container">
    <div class="row">
                          ...
                          <div class="color-picker"> 
                           ...
                           // echo "<pre>";print_r($option_values); 
                            foreach($option_values as $color_row) {
                                ...
                                echo "<img class='img1' src='image/cache/".$new_image."' height='17' width='17' alt='".$color_row['option_value_id']."'>";
                                echo "</span></a>&nbsp;&nbsp;";
