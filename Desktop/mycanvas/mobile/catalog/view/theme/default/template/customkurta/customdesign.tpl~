                        ...
                        <div class="item active">
                           ...
                           <div class="digitalsection">
                                 <div class="slider8">
                                            ...
                                            <?php } ?>
                                                <img class="digitalimg img-responsive nofill" style="border:1px soild #ccc;" alt="no-fill-patrn" src="upload/no-fill/no-fill-patrn.png" id="digi0" />
                             ...
                             <div class="embsection" style="display:none;">
                                 <div class="slider8">
                                      ...
                                      <?php } ?>
                                            <img class="embimg img-responsive nofill" style="border:1px soild #ccc;" alt="no-fill-patrn" src="upload/no-fill/no-fill-patrn.png" id="fab0" />
                             ...
                             <div class="blocksection" style="display:none;">
                                <div class="slider8">
                                        ...
                                        <?php } ?>
                                            <img class="block img-responsive nofill" style="border:1px soild #ccc;" id="block0" alt="no-fill-patrn" src="upload/no-fill/no-fill-patrn.png"  />
                             ...
                             <div class="screensection" style="display:none;">
                                <div class="slider8">
                                       ...
                                       <?php } ?>
                                            <img class="screenp img-responsive nofill"  style="border:1px soild #ccc;" id="screen0" alt="no-fill-patrn" src="upload/no-fill/no-fill-patrn.png"  />
                    ...
                    <div class="view_top">
                        <!--<img class="view_image" alt="" src="catalog/view/theme/default/image/images/icon_img34.png"> -->
                              <div class="frontcanvascontainer" id="frontcanvascontainer">
                                ...
                                <canvas id="neckcanvas" width=295 height=470 style="background: url(catalog/view/theme/default/image/canvasimgs/shirt_neck.png);position: absolute; z-index: 11;"></canvas>
                                ...
                                <canvas id="frontcanvas" width=295 height=470 style="background:url(); z-index: 99;">
                                </canvas>
                                <!--     CANVAS    -->
                            </div> 
