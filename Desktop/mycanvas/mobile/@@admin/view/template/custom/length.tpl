  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-popular" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" >Upload Image Icon</label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" >Upload Canvas Base Line Image</label>
            <div class="col-sm-10">
              <input type="file" name="can_base_lines1" value="" placeholder="" id="can_base_lines1" class="form-control uploadfile" />
             </div>
         </div>
    ...
    <input type="hidden" name="hidden2" value="space">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" >Upload Canvas Base Image</label>
            <div class="col-sm-10">
              <input type="file" name="can_base2" value="" placeholder="" id="can_base2" class="form-control uploadfile" />
             </div>
         </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" >Upload Canvas Base Line Image</label>
            <div class="col-sm-10">
              <input type="file" name="can_base_lines2" value="" placeholder="" id="can_base_lines2" class="form-control uploadfile" />
             </div>
         </div>
          <div class="form-group">
       ...
       <div class="listing">
                <table class="table table-striped table-bordered table-hover">
                    <tr>
                        <th>Length</th>
                        <th>Image Icon</th>
                        <th>Canvas Base Image</th>
                        <th>Canvas Base Line Image</th>
                        <th>Action</th>
                    </tr>
                    <?php 
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <img src="<?php echo $base.$lengthlisting['sleve_icon']; ?>" class="customimg" />
                        </td>
                        <td style="text-align: center;">
                            <img src="<?php echo $base.$lengthlisting['sleve_can_base']; ?>" class="customimg" />
                        </td>
                        <td style="text-align: center;">
                            <img src="<?php echo $base.$lengthlisting['sleve_can_outline']; ?>" class="customimg" />
                        </td>
                        <td style="text-align: center;">
...
$('.form-group .add-box').click(function(){
    ...
    txt = txt + " value=\"space\">";
    txt = txt + " <div class=\"form-group\">";
    txt = txt + " <label class=\"col-sm-2 control-label\" for=\"input-type\">Upload Image Icon</label>";
    txt = txt + "  <div class=\"col-sm-10\">";
    ...
    txt = txt + " <div class=\"form-group\">";
    txt = txt + " <label class=\"col-sm-2 control-label\" for=\"input-type\">Upload Canvas Base Image</label>";
    txt = txt + "  <div class=\"col-sm-10\">";
    txt = txt + " <input type=\"file\" name=\"can_base"+n+"\"  id=\"can_base"+n+"\" class=\"form-control uploadfile\">";
    txt = txt + "</div>";
    txt = txt + "</div>";
    txt = txt + "</div>";
    
    txt = txt + " <div class=\"form-group\">";
    txt = txt + " <label class=\"col-sm-2 control-label\" for=\"input-type\">Upload Canvas Base Line Image</label>";
    txt = txt + "  <div class=\"col-sm-10\">";
    txt = txt + " <input type=\"file\" name=\"can_base_lines"+n+"\"  id=\"can_base_lines"+n+"\" class=\"form-control uploadfile\">";
    txt = txt + "</div>";
    txt = txt + "</div>";
    txt = txt + "</div>";
