      ...
      <div class="panel-body">
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-popular" class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="file"  name="nbfile1" value="" placeholder="" id="nbfile1" class="form-control uploadfile" />
                    </div>
                 </div>
                <div class="form-group">
            ...
            <div class="listing">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php 
                        foreach($neckbtnlist as $neckbtnlisting)
                        {
                              $nbtnid = $neckbtnlisting['id'];
                    ?>
                    <tr>
                         <td style="text-align: center;">
                            <img src="<?php echo $base.$neckbtnlisting['neck_btnmain_img']; ?>" class="customimg" style="width:80px; height:80px;" />
                        </td>
                        <td style="text-align: center;">
                            <a href="javascript:void(0);" id='removeborder<?php echo $nbtnid ; ?>' data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger" onclick='deletenbtn("<?php echo $nbtnid ; ?>");'> <i class="fa fa-minus-circle"></i> </a>
                        </td>
                    </tr>
                    <?php } ?>
                </table>
...
function deletenbtn(id)
  {
    
     var url = 'index.php?route=custom/neck_button/deleteoptions&token=<?php echo $token; ?>';
     url += '&button=' + id;
     location = url;
...
$('.form-group .add-box').click(function(){
    ...
    txt = txt + "<input type=\"file\" name=\"nbfile"+n+"\"  id=\"nbfile"+n+"\" class=\"form-control uploadfile\">";
    txt = txt + "</div>";
    txt = txt + "</div>";
    txt = txt + "</div>";
